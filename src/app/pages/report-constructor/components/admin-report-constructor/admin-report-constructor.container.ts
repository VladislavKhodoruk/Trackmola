...
@Component({
  ...
  selector: 'app-admin-report-constructor-container',
  template: `<app-admin-report-constructor
  ...
  ></app-admin-report-constructor>`,
})
export class AdminReportConstructorContainer {
